...
let mouseDownFunction = function (event) {
  btnmem.style.filter = 'brightness(1.5)';
};

btnmem.addEventListener('mousedown', mouseDownFunction, false);
btnmem.addEventListener('touchstart', mouseDownFunction, false);

let mouseOutFunction1 = function (event) {
  btnmem.style.filter = 'brightness(100%)';
};

let mouseOutFunction2 = function (event) {
